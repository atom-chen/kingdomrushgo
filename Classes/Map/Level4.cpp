...
void Level4::addTerrains()
{
	...
	auto terrain13 = kr::Terrain::createTerrain(1);
	...
	auto terrain14 = kr::Terrain::createTerrain(1);
	...
	auto terrain15 = kr::Terrain::createTerrain(1);
	terrain15->setPosition(Point(295,340));
	terrain15->setTag(15);
	addChild(terrain15,7);

	auto terrain16 = kr::Terrain::createTerrain(1);
	...
	auto terrain11 = kr::Terrain::createTerrain(1);
	terrain11->setPosition(Point(615,265));
	terrain11->setTag(11);
	addChild(terrain11,8);

	auto terrain12 = kr::Terrain::createTerrain(1);
