...
{
	auto terrain1 = kr::Terrain::createTerrain(3);
	terrain1->setPosition(Point(230,630));
	terrain1->setTag(1);
	addChild(terrain1,7);

	auto terrain2 = kr::Terrain::createTerrain(3);
	terrain2->setPosition(Point(320,630));
	terrain2->setTag(2);
	addChild(terrain2,7);

	auto terrain3 = kr::Terrain::createTerrain(3);
	terrain3->setPosition(Point(436,630));
	terrain3->setTag(3);
	addChild(terrain3,7);

	auto terrain4 = kr::Terrain::createTerrain(3);
	terrain4->setPosition(Point(518,690));
	terrain4->setTag(4);
	addChild(terrain4,7);

	auto terrain5 = kr::Terrain::createTerrain(3);
	terrain5->setPosition(Point(589,603));
	terrain5->setTag(5);
	addChild(terrain5,7);

	auto terrain6 = kr::Terrain::createTerrain(3);
	terrain6->setPosition(Point(363,440));
	terrain6->setTag(6);
	addChild(terrain6,5);

	auto terrain7 =kr::Terrain::createTerrain(3);
	terrain7->setPosition(Point(502,420));
	terrain7->setTag(7);
	addChild(terrain7,5);

	auto terrain8 = kr::Terrain::createTerrain(3);
	terrain8->setPosition(Point(270,320));
	terrain8->setTag(8);
	addChild(terrain8,4);

	auto terrain9 = kr::Terrain::createTerrain(3);
	terrain9->setPosition(Point(510,230));
	terrain9->setTag(9);
	addChild(terrain9,3);

	auto terrain10 = kr::Terrain::createTerrain(3);
	terrain10->setPosition(Point(677,290));
	terrain10->setTag(10);
	addChild(terrain10,3);

	auto terrain11 = kr::Terrain::createTerrain(3);
	terrain11->setPosition(Point(890,160));
	terrain11->setTag(11);
	addChild(terrain11,2);

	auto terrain12 = kr::Terrain::createTerrain(3);
	terrain12->setPosition(Point(922,330));
	terrain12->setTag(12);
	addChild(terrain12,4);

	auto terrain13 = kr::Terrain::createTerrain(3);
	terrain13->setPosition(Point(715,450));
	terrain13->setTag(13);
	addChild(terrain13,5);

	auto terrain14 = kr::Terrain::createTerrain(3);
	terrain14->setPosition(Point(792,520));
	terrain14->setTag(14);
	addChild(terrain14,6);

	auto terrain15 = kr::Terrain::createTerrain(3);
